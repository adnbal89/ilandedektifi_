            ...
            <table class="table">
                ...
                <tb>
                    ...
                    ';
                        ...
                        echo "<td style='width:1%;'><a class='btn btn-success text-white' onclick='yayinla(" . $value["id"] . ")'>Yayınla</a><a class='btn btn-danger text-white' onclick='kaldir(" . $value["id"] . ")'>Kaldır</a></td>";
                        echo "</tr>";
                    }
                    ?>
                </tb>
